const ProductCard = ({ product, onAddToCart }) => {
  ...
  return (
    <div className="group h-full w-full">
      <div className="flex h-full flex-col overflow-hidden rounded-[24px] border border-gray-100 bg-white shadow-[0_10px_35px_-20px_rgba(15,23,42,0.35)] transition-all duration-300 hover:-translate-y-2 hover:shadow-[0_20px_45px_-20px_rgba(15,23,42,0.45)]">
        ...
        <div className="flex flex-1 flex-col px-4 pb-4 pt-3 sm:px-5 sm:pb-5">
          ...
          <h3 className="mt-1 line-clamp-2 text-base font-bold text-slate-800 sm:text-lg">
            {name}
          </h3>
          ...
          <button
            ...
            className="mt-5 inline-flex items-center justify-center rounded-full bg-slate-900 px-4 py-2.5 text-sm font-semibold text-white transition-all duration-300 hover:bg-black hover:shadow-lg"
          >
            Add to Cart
          </button>
        </div>
