    ...
    <div className="min-h-screen bg-slate-50 pb-28 md:pb-8">
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4 md:py-8">
        <button
          ...
          className="inline-flex items-center gap-2 text-slate-600 hover:text-slate-950 mb-4 md:mb-6 transition-colors"
          ...
          <div className="md:col-span-1">
            <div className="md:sticky md:top-36 space-y-4">
              ...
              <button
                ...
                className="hidden md:flex w-full px-6 py-3.5 bg-slate-950 text-white rounded-lg font-bold hover:bg-slate-800 transition-colors items-center justify-center"
              >
                Continue to Payment
              </button>
            </div>
